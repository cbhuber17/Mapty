...
class App {
  ...
  _getPosition() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        this._loadMap.bind(this), // In a regular function call loadMap, "this" is undefined.  To fix, bind to method.
  ...
  _loadMap(position) {
    // Current position if user accepts in browser
  ...
  _newWorkout(e) {
    // Helper function to check that input is valid
    const validInputs = (...inputs) =>
      inputs.every(inp => Number.isFinite(inp));

    // Helper function to check positivity
    ...
    // If activity is running/cycle, create those respective objects
    if (type === 'running') {
